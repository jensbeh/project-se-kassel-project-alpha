...
func _ready():
	...
	max_health = Constants.MobsSettings.RAT.Health
	health = max_health
	attack_damage = Constants.MobsSettings.RAT.AttackDamage
	knockback = Constants.MobsSettings.RAT.Knockback
	mob_weight = Constants.MobsSettings.RAT.Weight
	experience = Constants.MobsSettings.RAT.Experience
	spawn_time = Constants.MobsSettings.RAT.SpawnTime
	min_searching_time = Constants.MobsSettings.RAT.MinSearchingTime
	max_searching_time = Constants.MobsSettings.RAT.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.MobsSettings.RAT.HuntingSpeed
	WANDERING_SPEED = Constants.MobsSettings.RAT.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.MobsSettings.RAT.PreAttackingSpeed
