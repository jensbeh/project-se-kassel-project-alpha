...
func _ready():
	# Setup mob
	# Mob specific
	enemy_type = EnemyType.FUNGUS
	max_health = Constants.MobsSettings.FUNGUS.Health
	health = max_health
	attack_damage = Constants.MobsSettings.FUNGUS.AttackDamage
	knockback = Constants.MobsSettings.FUNGUS.Knockback
	mob_weight = Constants.MobsSettings.FUNGUS.Weight
	experience = Constants.MobsSettings.FUNGUS.Experience
	spawn_time = Constants.MobsSettings.FUNGUS.SpawnTime
	min_searching_time = Constants.MobsSettings.FUNGUS.MinSearchingTime
	max_searching_time = Constants.MobsSettings.FUNGUS.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.MobsSettings.FUNGUS.HuntingSpeed
	WANDERING_SPEED = Constants.MobsSettings.FUNGUS.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.MobsSettings.FUNGUS.PreAttackingSpeed
