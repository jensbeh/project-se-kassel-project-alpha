...
func _ready():
	# Setup mob
	# Mob specific
	enemy_type = EnemyType.SNAKE
	max_health = Constants.MobsSettings.SNAKE.Health
	health = max_health
	attack_damage = Constants.MobsSettings.SNAKE.AttackDamage
	knockback = Constants.MobsSettings.SNAKE.Knockback
	mob_weight = Constants.MobsSettings.SNAKE.Weight
	experience = Constants.MobsSettings.SNAKE.Experience
	spawn_time = Constants.MobsSettings.SNAKE.SpawnTime
	min_searching_time = Constants.MobsSettings.SNAKE.MinSearchingTime
	max_searching_time = Constants.MobsSettings.SNAKE.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.MobsSettings.SNAKE.HuntingSpeed
	WANDERING_SPEED = Constants.MobsSettings.SNAKE.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.MobsSettings.SNAKE.PreAttackingSpeed
