...
func _ready():
	...
	max_health = Constants.MobsSettings.ZOMBIE.Health
	health = max_health
	attack_damage = Constants.MobsSettings.ZOMBIE.AttackDamage
	knockback = Constants.MobsSettings.ZOMBIE.Knockback
	mob_weight = Constants.MobsSettings.ZOMBIE.Weight
	experience = Constants.MobsSettings.ZOMBIE.Experience
	spawn_time = Constants.MobsSettings.ZOMBIE.SpawnTime
	min_searching_time = Constants.MobsSettings.ZOMBIE.MinSearchingTime
	max_searching_time = Constants.MobsSettings.ZOMBIE.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.MobsSettings.ZOMBIE.HuntingSpeed
	WANDERING_SPEED = Constants.MobsSettings.ZOMBIE.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.MobsSettings.ZOMBIE.PreAttackingSpeed
