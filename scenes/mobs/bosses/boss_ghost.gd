...
func _ready():
	# Setup mob
	# Mob specific
	boss_type = BossType.BOSS_GHOST
	max_health = Constants.BossesSettings.BOSS_GHOST.Health
	health = max_health
	attack_damage = Constants.BossesSettings.BOSS_GHOST.AttackDamage
	knockback = Constants.BossesSettings.BOSS_GHOST.Knockback
	mob_weight = Constants.BossesSettings.BOSS_GHOST.Weight
	experience = Constants.BossesSettings.BOSS_GHOST.Experience
	spawn_time = Constants.BossesSettings.BOSS_GHOST.SpawnTime
	min_searching_time = Constants.BossesSettings.BOSS_GHOST.MinSearchingTime
	max_searching_time = Constants.BossesSettings.BOSS_GHOST.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.BossesSettings.BOSS_GHOST.HuntingSpeed
	WANDERING_SPEED = Constants.BossesSettings.BOSS_GHOST.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.BossesSettings.BOSS_GHOST.PreAttackingSpeed
