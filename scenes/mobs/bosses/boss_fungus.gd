...
func _ready():
	# Setup mob
	# Mob specific
	boss_type = BossType.BOSS_FUNGUS
	max_health = Constants.BossesSettings.BOSS_FUNGUS.Health
	health = max_health
	attack_damage = Constants.BossesSettings.BOSS_FUNGUS.AttackDamage
	knockback = Constants.BossesSettings.BOSS_FUNGUS.Knockback
	mob_weight = Constants.BossesSettings.BOSS_FUNGUS.Weight
	experience = Constants.BossesSettings.BOSS_FUNGUS.Experience
	spawn_time = Constants.BossesSettings.BOSS_FUNGUS.SpawnTime
	min_searching_time = Constants.BossesSettings.BOSS_FUNGUS.MinSearchingTime
	max_searching_time = Constants.BossesSettings.BOSS_FUNGUS.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.BossesSettings.BOSS_FUNGUS.HuntingSpeed
	WANDERING_SPEED = Constants.BossesSettings.BOSS_FUNGUS.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.BossesSettings.BOSS_FUNGUS.PreAttackingSpeed
