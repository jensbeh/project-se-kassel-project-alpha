...
func _ready():
	# Setup mob
	# Mob specific
	boss_type = BossType.BOSS_ZOMBIE
	max_health = Constants.BossesSettings.BOSS_ZOMBIE.Health
	health = max_health
	attack_damage = Constants.BossesSettings.BOSS_ZOMBIE.AttackDamage
	knockback = Constants.BossesSettings.BOSS_ZOMBIE.Knockback
	mob_weight = Constants.BossesSettings.BOSS_ZOMBIE.Weight
	experience = Constants.BossesSettings.BOSS_ZOMBIE.Experience
	spawn_time = Constants.BossesSettings.BOSS_ZOMBIE.SpawnTime
	min_searching_time = Constants.BossesSettings.BOSS_ZOMBIE.MinSearchingTime
	max_searching_time = Constants.BossesSettings.BOSS_ZOMBIE.MaxSearchingTime
	
	# Constants
	HUNTING_SPEED = Constants.BossesSettings.BOSS_ZOMBIE.HuntingSpeed
	WANDERING_SPEED = Constants.BossesSettings.BOSS_ZOMBIE.WanderingSpeed
	PRE_ATTACKING_SPEED = Constants.BossesSettings.BOSS_ZOMBIE.PreAttackingSpeed
