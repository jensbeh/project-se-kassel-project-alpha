...
const HAIR_SPRITESHEET = {
	...
	6: preload("res://assets/player/hair/french_curl.png"),
	7: preload("res://assets/player/hair/gentleman.png"),
	8: preload("res://assets/player/hair/long_straight .png"),
	9: preload("res://assets/player/hair/long_straight_skirt.png"),
	10: preload("res://assets/player/hair/midiwave.png"),
	11: preload("res://assets/player/hair/ponytail .png"),
	12: preload("res://assets/player/hair/spacebuns.png"),
	13: preload("res://assets/player/hair/wavy.png"),
}
