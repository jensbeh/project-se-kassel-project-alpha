...
const body_spritesheet = {
	...
	3: preload("res://assets/player/characters/char4.png"),
	4: preload("res://assets/player/characters/char5.png"),
	5: preload("res://assets/player/characters/char6.png"),
	6: preload("res://assets/player/characters/char7.png"),
...
const hat_spritesheet = {
	...
	3: preload("res://assets/player/acc/hat_pumpkin_purple.png"),
...
const hair_spritesheet = {
	...
	3: preload("res://assets/player/hair/curly.png"),
	4: preload("res://assets/player/hair/emo.png"),
	5: preload("res://assets/player/hair/extra_long.png"),
	6: preload("res://assets/player/hair/extra_long_skirt.png"),
	7: preload("res://assets/player/hair/french_curl.png"),
	8: preload("res://assets/player/hair/gentleman.png"),
	9: preload("res://assets/player/hair/long_straight .png"),
	10: preload("res://assets/player/hair/long_straight_skirt.png"),
	11: preload("res://assets/player/hair/midiwave.png"),
	12: preload("res://assets/player/hair/ponytail .png"),
	13: preload("res://assets/player/hair/spacebuns.png"),
	14: preload("res://assets/player/hair/wavy.png"),
}
