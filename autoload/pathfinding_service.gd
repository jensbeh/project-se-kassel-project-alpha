...
func init(new_mobNavigationTilemap : TileMap = null, new_ambientMobsNavigationTileMap : TileMap = null, new_map_size_in_tiles : Vector2 = Vector2.ZERO):
...
# Method calculates the index of the point in astar_nodes
func calculate_point_index(point):
	return abs(point.x + map_size_in_tiles.x * point.y)


# Method to check if point is inside map
...
func get_ambient_mob_astar_path(mob_start, mob_end):
	...
	var path_start_position = ambientMobsNavigationTileMap.world_to_map(mob_start)
	var path_end_position = ambientMobsNavigationTileMap.world_to_map(mob_end)
	var start_point_index = calculate_point_index(path_start_position)
	var end_point_index = calculate_point_index(path_end_position)
	print("mob_start: " + str(mob_start))
	print("mob_end: " + str(mob_end))
	print("path_start_position: " + str(path_start_position))
	print("path_end_position: " + str(path_end_position))
